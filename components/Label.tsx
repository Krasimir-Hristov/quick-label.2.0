    ...
    >
      ...
      <div className='relative border-b-2 border-gray-400 p-2'>
        <div className='flex items-start gap-x-2'>
          ...
          {/* Product Name - използва Lexia Std шрифт */}
          <div className='text-left'>
            <h2
              className='text-xl font-bold leading-tight text-center break-words font-lexia-std'
      ...
      <div className='px-2 py-1 flex-1 flex flex-col'>
        ...
        <div className='flex-1 flex flex-col justify-center space-y-0'>
          <div className='text-center'>
            {' '}
            {/* "APP VORTEIL" бадж - DIN Engschrift шрифт */}
            <div className='bg-black text-white font-bold tracking-wider py-1 px-3 inline-block rounded-full'>
              <span className='text-3xl whitespace-nowrap font-din-engschrift-std'>
                APP VORTEIL
              </span>
            </div>
          </div>
          <div className='text-center'>
            {' '}
            {/* "DEIN PREIS" текст - DIN Engschrift шрифт */}
            <p className='text-black text-lg font-bold leading-none mt-1 font-din-engschrift-std'>
              DEIN PREIS MIT DER
              <br />
              <span className='text-2xl font-bold font-din-engschrift-std'>
                KÖLLE ZOO APP
              </span>
            </p>
          </div>
